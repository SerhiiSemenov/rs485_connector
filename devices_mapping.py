...
map_table = {
    ...
    #kid area
    "home/kidroom/recuperator_low_speed": ["kidroom recuperator low speed", 0x5, 0x1],
    "home/kidroom/recuperator_shutter_power": ["kidroom room recuperator hi speed", 0x5, 0x3],
